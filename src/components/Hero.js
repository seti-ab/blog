            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto py-6 sm:py-8">
                    ...
                    <div className="flex justify-center flex-wrap md:flex-nowrap md:justify-between mx-auto md:h-[60vh] gap-7 mt-16 max-w-7xl px-2 sm:px-6 lg:px-8 ">
                        ...
                        <Card label="Featured Articles" className="!px-12 md:basis-5/12 rounded-2xl shadow-xl" title="Sunset in the mountains" content="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil." />
                    </div>
                </div>
            </div>
        </div>
